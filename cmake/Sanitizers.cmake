function(
    ...
    if ((CMAKE_CXX_COMPILER_ID STREQUAL "GNU" OR CMAKE_CXX_COMPILER_ID MATCHES ".*Clang") AND (NOT ${CMAKE_SYSTEM_NAME} MATCHES "Darwin"))
        set(SANITIZERS "")
    ...
    if (LIST_OF_SANITIZERS)
        if (NOT
                ...
                "")
            if (NOT MSVC)
                target_compile_options(${project_name} BEFORE INTERFACE -fsanitize=${LIST_OF_SANITIZERS})
                target_link_options(${project_name} BEFORE INTERFACE -fsanitize=${LIST_OF_SANITIZERS})
            else ()
