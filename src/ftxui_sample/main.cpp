...
// configuration step. It creates a namespace called `poutre2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", poutre2::cmake::project_name, poutre2::cmake::project_version) };
