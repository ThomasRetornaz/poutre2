...
/**
 * @file   label_binary.hpp
 * @author Thomas Retornaz
 * @brief  Label foreground set
 *
 *
 */
...
/*!@brief Label foreground pixel according to nl_static
 * \warning o_img must be 64 bits (PType_GrayINT64) to avoid overflow
 * @return number of labels
 */
LAB_API std::size_t label_binary(const IInterface &i_img, se::Common_NL_SE nl_static, IInterface &o_img);
