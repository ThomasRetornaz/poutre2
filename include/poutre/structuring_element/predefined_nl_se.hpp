 ...
 */
SE_API extern const details::neighbor_list_t< 2 > SESquare2D;
 ...
 */
SE_API extern const details::neighbor_list_t< 2 > SECross2D;
 ...
 *
 */
SE_API extern const details::neighbor_list_t< 1 > SESegmentX1D;
 ...
 * . . .
 */
SE_API extern const details::neighbor_list_t< 2 > SESegmentX2D;
 ...
 *  . x . @n
 */
SE_API extern const details::neighbor_list_t< 2 > SESegmentY2D;

/*! Line structuring element / segment of unit size along X (3D)
 */
SE_API extern const details::neighbor_list_t< 3 > SESegmentX3D;

/*! Line structuring element / segment of unit size along Y (3D)
 */
SE_API extern const details::neighbor_list_t< 3 > SESegmentY3D;

/*! Line structuring element / segment of unit size along Z (3D)
 */
SE_API extern const details::neighbor_list_t< 3 > SESegmentZ3D;
 ...
 */
SE_API extern const details::neighbor_list_t< 3 > SESquare3D;
 ...
 */
SE_API extern const details::neighbor_list_t< 3 > SECross3D;
